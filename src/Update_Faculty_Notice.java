...
public class Update_Faculty_Notice extends JInternalFrame implements ActionListener

{
	JLabel title=new JLabel("Update Faculty Notice",JLabel.CENTER);
	...
	Update_Faculty_Notice()
	{
		super("Update Faculty Notice",false,true,false,true);
