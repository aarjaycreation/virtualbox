...
public class Print_Faculty_Notice extends JInternalFrame implements ActionListener

{
	JLabel title=new JLabel("Print Faculty Notice",JLabel.CENTER);

	JComboBox com1=new JComboBox();
	JComboBox com2=new JComboBox();

	JLabel l1=new JLabel("Select Faculty Member :",JLabel.RIGHT);
	...
	Print_Faculty_Notice()
	{
		super("Print Faculty Notice",false,true,false,true);
	...
	public void dataConnection()
	{
		try
		{
			...
			rs=st.executeQuery("Select * from FacOff where Type='Faculty'");
		}
		catch(Exception ce)
		{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==com1)
		{
			...
			{
				String comname=((String)com1.getSelectedItem());
				rs3=st3.executeQuery("select * from FacOff where FO_Name='"+comname+"'");
