...
public class View_Official_Notice extends JInternalFrame implements ActionListener

{
	JLabel title=new JLabel("View Official Notice",JLabel.CENTER);
	...
	View_Official_Notice()
	{
		super("View Official Notice",false,true,false,true);
