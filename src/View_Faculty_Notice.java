...
public class View_Faculty_Notice extends JInternalFrame implements ActionListener

{
	JLabel title=new JLabel("View Faculty Notice",JLabel.CENTER);
	...
	View_Faculty_Notice()
	{
		super("View Faculty Notice",false,true,false,true);
