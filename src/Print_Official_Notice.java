...
public class Print_Official_Notice extends JInternalFrame implements ActionListener

{
	JLabel title=new JLabel("Print Official Notice",JLabel.CENTER);
	...
	Print_Official_Notice()
	{
		super("Print Official Notice",false,true,false,true);
