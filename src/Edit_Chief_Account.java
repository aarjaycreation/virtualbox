...
public class Edit_Chief_Account extends JInternalFrame implements ActionListener

{
	JLabel title=new JLabel("Edit/Delete Chief Account",JLabel.CENTER);
	...
	Edit_Chief_Account()
	{
		super("Edit/Delete Chief Account",false,true,false,true);
	...
	public void dataConnection1()
	{
		...
		{
			Class.forName("com.mysql.jdbc.Driver");
                        con1=DriverManager.getConnection("jdbc:mysql://localhost/db","root","");
	...
	public void dataConnection2()
	{
		...
		{
		        Class.forName("com.mysql.jdbc.Driver");
                        con2=DriverManager.getConnection("jdbc:mysql://localhost/db","root","");
	...
	public void dataConnection4()
	{
		...
		{
			Class.forName("com.mysql.jdbc.Driver");
                        con4=DriverManager.getConnection("jdbc:mysql://localhost/db","root","");
	...
	public void dataConnection5()
	{
		...
		{
			Class.forName("com.mysql.jdbc.Driver");
                        con5=DriverManager.getConnection("jdbc:mysql://localhost/db","root","");
	...
	public void dataConnection6()
	{
		...
		{
			Class.forName("com.mysql.jdbc.Driver");
                        con6=DriverManager.getConnection("jdbc:mysql://localhost/db","root","");
	...
	public void dataConnection7()
	{
		...
		{
			Class.forName("com.mysql.jdbc.Driver");
                        con7=DriverManager.getConnection("jdbc:mysql://localhost/db","root","");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
		dataConnection7();
		String trypass=JOptionPane.showInputDialog(this,"Enter Password for Account Update:");
		...
		if (trypass.equals(okay))
		{
			...
			try
			{
				...
				rs1=st1.executeQuery("select * from Chief where C_Name='"+comname+"'");
		...
		if(e.getSource()==b1)
		{
			...
			try
			{
				...
				String query="update Chief set C_Password='"+t1.getText()+"',C_Designation='"+t3.getText()+"'where C_Name='"+comname+"'";
		...
		if(e.getSource()==b2)
		{
			try
			{
				...
				String query="delete from Chief where C_Name='"+comname+"'";
