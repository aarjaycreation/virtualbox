...
public class Official_Account_Signup extends JInternalFrame implements ActionListener

{
	JLabel title=new JLabel("Signup Form of Official Member",JLabel.CENTER);
