...
public class Edit_Faculty_Account extends JInternalFrame implements ActionListener

{
	JLabel title=new JLabel("Edit/Delete Faculty Account",JLabel.CENTER);
	...
	Edit_Faculty_Account()
	{
		super("Edit/Delete Faculty Account",false,true,false,true);
