...
public class Update_Official_Notice extends JInternalFrame implements ActionListener

{
	JLabel title=new JLabel("Update Official Notice",JLabel.CENTER);
	...
	Update_Official_Notice()
	{
		super("Update Official Notice",false,true,false,true);
